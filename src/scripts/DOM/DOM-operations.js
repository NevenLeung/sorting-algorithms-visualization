/**
 * @module DOM Operation Module
 *
 * 将常用的DOM操作进行封装
 *
 * @export {object} {appendMultiChild, query, queryAll, findClosestAncestor, findSibling, findSiblings}
 */
 ...
 *
 * @param $el  基准元素
 * @param selector {string}  有效的css选择器字符串
 *
 * @return {Object|null}  查找的元素对象或者null
 */
